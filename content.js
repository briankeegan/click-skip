...
const removeNodeBySelector = async (selector, frequency = 100) => {
...
const ListOfSites = [
  ...
  },
  {
    ...
    customScripts: [
      () => removeNodeBySelector('[class*=modal_modal-window-container]', 1000),
      () => removeNodeBySelector('[class*=adunit_ad-unit]'),
      nyTimesAddScrollability
    ]
  },
];
